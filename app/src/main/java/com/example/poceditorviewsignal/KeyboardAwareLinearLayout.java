...
public class KeyboardAwareLinearLayout extends LinearLayoutCompat {
  private static final String TAG = "org.thoughtcrime.securesms.components.KeyboardAwareLinearLayout.class.getSimpleName()";
  ...
  public KeyboardAwareLinearLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    minKeyboardSize                     = getResources().getDimensionPixelSize(R.dimen.crop_area_renderer_edge_size);
    minCustomKeyboardSize               = getResources().getDimensionPixelSize(R.dimen.crop_area_renderer_edge_size);
    defaultCustomKeyboardSize           = getResources().getDimensionPixelSize(R.dimen.crop_area_renderer_edge_size);
    minCustomKeyboardTopMarginPortrait  = getResources().getDimensionPixelSize(R.dimen.crop_area_renderer_edge_size);
    minCustomKeyboardTopMarginLandscape = getResources().getDimensionPixelSize(R.dimen.crop_area_renderer_edge_size);
