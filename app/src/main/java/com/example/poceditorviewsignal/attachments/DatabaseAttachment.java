...
public class DatabaseAttachment extends Attachment {
  ...
  {
    super(contentType, transferProgress, size, fileName, cdnNumber, location, key, relay, digest, fastPreflightId, voiceNote, borderless, width, height, quote, uploadTimestamp, caption, blurHash, audioHash, transformProperties);
