...
public class UriAttachment extends Attachment {
  ...
  {
    this(uri, contentType, transferState, size, 0, 0, fileName, null, voiceNote, borderless, quote, caption, blurHash);
  }
  ...
  public UriAttachment(@NonNull Uri dataUri,
                       ...
                       @Nullable BlurHash blurHash)
  {
    super(contentType, transferState, size, fileName, 0, null, null, null, null, fastPreflightId, voiceNote, borderless, width, height, quote, 0, caption, blurHash);
