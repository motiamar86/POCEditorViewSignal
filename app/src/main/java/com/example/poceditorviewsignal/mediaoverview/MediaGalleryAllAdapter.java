...
package com.example.poceditorviewsignal.mediaoverview;
...
import com.example.poceditorviewsignal.mediasend.CameraContactAdapter;
...
final class MediaGalleryAllAdapter extends StickyHeaderGridAdapter {
  ...
  private static class HeaderHolder extends CameraContactAdapter.HeaderViewHolder {
    TextView textView;
  ...
  @Override
  public CameraContactAdapter.HeaderViewHolder onCreateHeaderViewHolder(ViewGroup parent, int headerType) {
