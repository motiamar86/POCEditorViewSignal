...
public class VideoSlide extends Slide {
  ...
  public VideoSlide(Context context, Uri uri, long dataSize, @Nullable String caption) {
    super(context, constructAttachmentFromUri(context, uri, MediaUtil.VIDEO_UNSPECIFIED, dataSize, 0, 0, MediaUtil.hasVideoThumbnail(context, uri), null, caption, null,  false, false, false));
  }

  public VideoSlide(Context context, Uri uri, long dataSize, int width, int height, @Nullable String caption) {
    super(context, constructAttachmentFromUri(context, uri, MediaUtil.VIDEO_UNSPECIFIED, dataSize, width, height, MediaUtil.hasVideoThumbnail(context, uri), null, caption, null, false, false, false));
  }
