...
import com.example.poceditorviewsignal.media.MediaMetadataRetrieverUtil;
import com.example.poceditorviewsignal.mms.GifSlide;
import com.example.poceditorviewsignal.mms.ImageSlide;
...
public class MediaUtil {
  ...
  Slide getSlideForAttachment(Context context, Attachment attachment) {
    ...
    switch (getSlideTypeFromContentType(attachment.getContentType())) {
      ...
      //ase VIEW_ONCE : return new ViewOnceSlide(context, attachment);
  ...
  //TODO In order to get video thumbnail we need to fix some things in this code
    return null;
  }
